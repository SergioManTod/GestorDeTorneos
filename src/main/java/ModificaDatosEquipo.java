...
public class ModificaDatosEquipo extends JFrame {
	...
	public ModificaDatosEquipo() {
		...
		// EN ESTE TEXTFIEL, DEBE MOSTRARSE EL NOMBRE DEL EQUIPO PILLADO DE LA BASE DE DATOS Y TAMBIEN SE PUEDE SOBRE ESCRIBIR Y HACER UNA EDIT EN LA BBDD
		...
		// EN ESTE TEXTFIEL, DEBE MOSTRARSE EL MAIL DEL EQUIPO PILLADO DE LA BASE DE DATOS Y TAMBIEN SE PUEDE SOBRE ESCRIBIR Y HACER UNA EDIT EN LA BBDD
		...
		comboBoxJugador.setModel(new DefaultComboBoxModel(new String[] {">SELECCIONE JUGADOR<", "jose alberto Medina Cuesta", "Erik Johan Khol Gutierrez", "Gabriel Michael Willers", "Bruno Edgardo Todaro"}));//AQUI VA CONEXION A BB DD
		...
		// EN ESTE TEXTFIEL, DEBE MOSTRARSE EL NOMBRE  DEL JUGADOR PILLADO DE LA BASE DE DATOS Y TAMBIEN SE PUEDE SOBRE ESCRIBIR Y HACER UNA EDIT EN LA BBDD
		...
		// EN ESTE JDateChooser, DEBE MOSTRARSE LA FECHA DE NACIMIENTO  DEL JUGADOR PILLADO DE LA BASE DE DATOS Y TAMBIEN SE PUEDE SELECCIONAR EN EL CALENDARIO Y HACER UNA EDIT EN LA BBDD
		...
		// EN ESTE TEXTFIEL, DEBE MOSTRARSE EL 1� APELLIDO  DEL JUGADOR PILLADO DE LA BASE DE DATOS Y TAMBIEN SE PUEDE SOBRE ESCRIBIR Y HACER UNA EDIT EN LA BBDD
		...
		//ESTE CHECKBOX DEBE APARECER SELECCIONADO SI EN LOS DATOS DE LA BB DD DICE QUE ES EL DELEGADO, Y TAMBIEN SE PUEDE MODIFICAR CON UN EDIT
		...
		//ESTE CHECKBOX DEBE APARECER SELECCIONADO SI EN LOS DATOS DE LA BB DD DICE QUE ES EL ARBITRO, Y TAMBIEN SE PUEDE MODIFICAR CON UN EDIT
		...
		// BOTON PARA ELIMINAR JUGADOR SELECCIONADO (CUIDADO, SE DEBEN ELIMINAR TODOS LOS DATOS DE EL JUGADOR PERO ESTO NO DEBE AFECTAR A LOS PUNTOS DEL EQUIPO)
