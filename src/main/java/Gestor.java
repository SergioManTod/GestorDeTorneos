...
public class Gestor extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Gestor frame = new Gestor(null); // Pasar null o la conexión según corresponda
    ...
    public Gestor(Connection conn) {
        ...
        setTitle("Gestor de Torneos V. Gamma - Menú principal");
        ...
        // FIN DEL CODIGO PARA DAR ESTILO HOVER AL BOTON
        ...
        JLabel taglistsolicitudes = new JLabel("Listar Formularios de inscripción recibidos:");
