    ...
    public Gestor() {
		...
		botonCreaTorneo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                creaTorneo.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
		...
		botonListarFormulariosRecibidos.addActionListener(new ActionListener() {
		            ...
		            public void actionPerformed(ActionEvent e) {
		                ...
		                inscripcionesRecibidas.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);// CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
		...
		botonIniciaTorneo.addActionListener(new ActionListener() {
				            ...
				            public void actionPerformed(ActionEvent e) {
				                ...
				                iniciaTorneo.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
				                iniciaTorneo.setVisible(true);
				            }
				        });
		contentPane.add(botonIniciaTorneo);
		
		// SECCION PARA MODIFICAR O ELIMINAR  EQUIPOS Y A�ADIR, MODIFICAR O ELIMINAR JUGADORES
		...
		botonModEquipo.addActionListener(new ActionListener() {
						            ...
						            public void actionPerformed(ActionEvent e) {
						                ...
						                modificaDatosEquipo.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
		...
		botonVerClasificacion.addActionListener(new ActionListener() {
								            ...
								            public void actionPerformed(ActionEvent e) {
								                ...
								                clasificaciones.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
		...
		botonVerTablaGoleadores.addActionListener(new ActionListener() {
										            ...
										            public void actionPerformed(ActionEvent e) {
										                ...
										                goleadores.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // CIERRA LA APLICACI�N AL CERRAR ESTA VENTANA
		...
		JButton botonCerrar = new JButton("CERRAR APLICACIÓN");
	     ...
	     // INICIO DEL CODIGO PARA DAR ESTILO AL BOTON CUANDO HACEMOS HOVER
	        ...
	        botonCerrar.addActionListener(new ActionListener() {
							            @Override
							            public void actionPerformed(ActionEvent e) {
							            	 // Cerrar la conexi�n a la base de datos al cerrar la aplicaci�n
